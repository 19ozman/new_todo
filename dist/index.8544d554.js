...
})({"5827s":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "f340b4988544d554";
"use strict";
...
},{}],"4Zt2R":[function(require,module,exports) {
...
window.onload = function() {
    ...
    let theOpt = document.getElementById("filterId");
...
function pageCreation() {
    ...
    const mySpanSort = document.createElement("span");
    mySpanSort.className = "spanSort";
    mySpanSort.innerText = "Sort";
    myForm.appendChild(mySpanSort);
    const myFilter = document.createElement("select");
    ...
    const infoTre = document.createElement("span");
...
function addTodo() {
    let input = document.getElementById("theInputId");
    let newTodo = new _todo.Todo(input.value, false);
    todos1.push(newTodo);
    input.value = "";
    htmlCreation();
}
...
function htmlCreation() {
    ...
    let todoList = document.getElementById("theUlId");
    todoList.innerHTML = "";
    for(let i = 0; i < todos1.length; i++){
        ...
        myLi.addEventListener("click", ()=>{
            todos1[i].completed = !todos1[i].completed;
            htmlCreation();
            location.reload();
        });
        ...
        mySpan.innerHTML = todos1[i].item;
        if (todos1[i].completed) myLi.className = "liCmp";
...
function filterTodo(e) {
    let theUnordered = document.getElementById("theUlId");
    const todos = [
        ...theUnordered.children,
        HTMLUListElement
    ];
    console.log(todos);
    todos.forEach((theLis)=>{
        switch(e.target.value){
            case "all":
                theLis.style.display = "block";
                break;
            case "active":
                if (theLis.classList.contains("liCmp")) theLis.style.display = "none";
                else theLis.style.display = "block";
                break;
            case "completed":
                if (!theLis.classList.contains("liAll")) theLis.style.display = "block";
                else theLis.style.display = "none";
                break;
        }
    });
} // END OF FILTER --- END OF FILTER --- END OF FILTER

},{"./models/Todo":"64aeX"}],"64aeX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Todo", ()=>Todo
);
class Todo {
    constructor(todo, boolean){
        this.item = todo;
...
},{}]},["5827s","4Zt2R"], "4Zt2R", "parcelRequire4c47")

//# sourceMappingURL=index.8544d554.js.map
